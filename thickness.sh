...
echo -e "com of group 0 plus com of group 1" | gmx distance -f membrane_nj_centered_nobox.xtc -s md.tpr -oav thickness.xvg -xvg xmgrace -n headgroups.ndx -b 0 -tu ns
